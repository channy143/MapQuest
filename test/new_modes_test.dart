...
void main() {
  ...
  group('Learning Mode - Precise Coordinates & Back Navigation', () {
    testWidgets('Displays TIYAK NA LOKASYON badge and coordinates on location modal',
      ...
      // Check TIYAK NA LOKASYON badge
      expect(find.textContaining('TIYAK NA LOKASYON'), findsOneWidget);
      expect(find.textContaining('16.6° H Latitud, 121.3° S Longhitud'), findsOneWidget);
  ...
  group('Coordinate Quest & Persistence', () {
    ...
    testWidgets('Coordinate Quest hides unrevealed pins and reveals pin upon correct coordinate answer',
      ...
      expect(find.textContaining('0 / 20 Nabuksan'), findsOneWidget);
      ...
      // Progress counter increases to 1 / 20
      expect(find.textContaining('1 / 20 Nabuksan'), findsOneWidget);
